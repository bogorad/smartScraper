...
function getBaseDomain(hostname) {
  // ... (existing code) ...
  // Consider adding similar debug prints here if issues arise with getBaseDomain
  ...
  try {
    ...
    if (parts.length > 2) {
      ...
      if ((secondLastPart.length === 2 || secondLastPart === 'com' || secondLastPart === 'net' || secondLastPart === 'org' || secondLastPart === 'gov') && lastPart.length === 2) {
