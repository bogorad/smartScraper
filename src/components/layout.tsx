        ...
        <nav class="nav">
          <div class="nav-inner">
            ...
            <a
              ...
              class={`nav-link ${activePath === "/dashboard/sites" ? "active" : ""}`}
            >
              Sites
            </a>
            <a
              href="/dashboard/stats"
              class={`nav-link ${activePath === "/dashboard/stats" ? "active" : ""}`}
            >
              Stats
            </a>
            ...
            <span class="nav-version">
              <a
                target="_blank"
                href="https://github.com/bogorad/smartScraper"
              >
                <img
...
export const LoginLayout: FC<
  PropsWithChildren<{ title?: string; theme?: string }>
> = ({
  children,
  title = "Login - SmartScraper",
  theme = "light",
}) => {
  return (
    <html lang="en" data-theme={theme}>
