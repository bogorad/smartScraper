...
// Corrected import: Get the named scraperSettings from config/index.js
import { scraperSettings } from '../../config/index.js';

class ContentScoringEngine {
  constructor(scoreWeights, minParagraphThreshold, descriptiveKeywords) {
    ...
    if (scraperSettings.debug) {
        logger.debug('[DEBUG_MODE] ContentScoringEngine constructor params:', {
            scoreWeightsKeys: Object.keys(scoreWeights || {}).length > 0 ? Object.keys(scoreWeights) : 'Used defaults from scraperSettings',
